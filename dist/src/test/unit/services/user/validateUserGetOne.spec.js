...
describe("User get test", function () {
    ...
    test("Should be able to get the specific user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var name, email, password, avatar, contact, userData, user, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, (0, supertest_1.default)(__1.default)
                            .get("/api/users/".concat(user.body.id))
                            .set("Authorization", "Bearer " + token(true))];
                case 2:
                    response = _a.sent();
    ...
    test("Should not find any user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(__1.default)
                        .get("/api/users/".concat((0, uuid_1.v4)()))
                        .set("Authorization", "Bearer " + token(true))];
                case 1:
                    response = _a.sent();
...
//# sourceMappingURL=validateUserGetOne.spec.js.map