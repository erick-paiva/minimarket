...
describe("User update test", function () {
    ...
    test("Should be able to update the specified user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, (0, supertest_1.default)(__1.default)
                            .patch("/api/users/".concat(user.body.id))
                            .send({ name: "Kenzinho" })
                            .set("Authorization", "Bearer " + token(true))];
                case 2:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(__1.default)
                        .patch("/api/users/".concat((0, uuid_1.v4)()))
                        .set("Authorization", "Bearer " + token(true))];
                case 1:
                    response = _a.sent();
...
//# sourceMappingURL=validateUserUpdate.spec.js.map