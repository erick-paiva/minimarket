...
describe("User get test", function () {
    ...
    test("Should be able to get all users", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    test("Should be able to get your own user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var name, email, password, avatar, contact, userData, login, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//# sourceMappingURL=validateUserGet.spec.js.map