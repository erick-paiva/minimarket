...
describe("Post Establishment test", function () {
    ...
    test("Return: Body stablishments | Status code: 200", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, createUserResponse, loginResponse, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = {
...
//# sourceMappingURL=validateEstablishmentGetAll.spec.js.map