...
(0, dotenv_1.config)();
describe("Client Create test", function () {
    var connection;
    ...
    test("Should be able to create a new client", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test("Shouldn't be able to create a new client", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(__1.default)
...
//# sourceMappingURL=validateClientCreate.spec.js.map