    ...
    function UserController() {
        ...
        this.createUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_service_1.default.createUser(req)];
                    case 1:
                        user = _a.sent();
        ...
        this.loginUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, status, message, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_service_1.default.loginUser(req.body)];
                    case 1:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user_service_1.default.getUser(req)];
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res.status(200)).json;
                        return [4 /*yield*/, user_service_1.default.getByid(req)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        }); };
        this.isActive = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res.status(200)).json;
                        return [4 /*yield*/, user_service_1.default.isActive(req)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        }); };
        this.update = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res.status(200)).json;
                        return [4 /*yield*/, user_service_1.default.update(req)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        }); };
